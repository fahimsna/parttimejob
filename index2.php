...
<div class="job-container">
        ...
        ?>
            ...
            <div class="job-card">
                <div class="logo">
                    ...
                    if (!empty($row['img'])): 
                        $imgUrl = $row['img'];
                        // Fix relative paths by attaching the live Bdjobs production server domain prefix
                        if (strpos($imgUrl, 'http') === false) {
                            $imgUrl = "https://storage.googleapis.com/bdjobs/recruiter/" . $imgUrl;
                        }
                    ?>
                        <img src="<?php echo htmlspecialchars($imgUrl); ?>" alt="Company Logo">
                    <?php else: ?>
    ...
    <div class="pagination">
        <?php 
        // Dynamic path generator for stability across pagination routes
